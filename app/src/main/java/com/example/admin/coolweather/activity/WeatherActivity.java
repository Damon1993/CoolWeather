...
import com.example.admin.coolweather.service.AutoUpdataService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId){
        ...
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId +"&key=f6f045d314b84d70ae818b96fca1226f";
    ...
    private void showWeatherInfo(Weather weather){
        ...
        for (Forecast forecast : weather.forecastList){
            ...
            TextView infiText = (TextView) view.findViewById(R.id.info_text);
            TextView maxText = (TextView) view.findViewById(R.id.max_text);
            TextView minText = (TextView) view.findViewById(R.id.min_text);

            dateText.setText(forecast.data);
            infiText.setText(forecast.more.info);
